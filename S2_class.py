...
class S2(object):
    ...
    def draw_binary_grid_graph(self, fig_num=0):
        ...
        nx.draw_networkx_nodes(self.G, pos=pos, nodelist=class_1, node_size=50, node_color='r')
        ...
        nx.draw_networkx_nodes(self.G, pos=pos, nodelist=class_2, node_size=100, node_color='g')
        ...
        plt.axis('off')
        plt.savefig('S2_progress_'+str(fig_num)+'.png', dpi=400)
    ...
    def find_cut_edge(self):
        while(len(self.shortest2_path)!=2):
...
S2_model = S2(nr=10, nc=10, ratio=0.7, budget=10)
